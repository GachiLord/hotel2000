...
docker cp ./guest_journal.csv hotel2000:/goods.csv
docker exec hotel2000 psql -U postgres -d hotel2000 -c "COPY orders(title, price) FROM '/goods.csv' DELIMITER ',' CSV HEADER;"
